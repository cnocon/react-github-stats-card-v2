...
class ServeCommand {
    async apply(cli) {
        ...
        cli.makeCommand({
        ...
        }, [...builtInOptions, ...devServerFlags], async (program) => {
            ...
            webpackOptions.env = Object.assign({ WEBPACK_SERVE: true }, options.env);
            ...
            try {
                servers = await startDevServer_1.default(compiler, devServerOptions, logger);
            }
            catch (error) {
